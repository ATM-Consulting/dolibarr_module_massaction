...
<div class="tabsAction">
	[onshow;block=begin;when [user.rights.massactionpdf.write;noerr]=1]

		[onshow;block=begin;when [object.status]=[massactionpdf.STATUS_DRAFT]]
		...
		[onshow;block=begin;when [object.status]=[massactionpdf.STATUS_VALIDATED]]
		...
		<!-- '-+' est l'équivalent d'un signe '<' (TBS oblige) -->
		[onshow;block=begin;when [object.status]-+[massactionpdf.STATUS_REFUSED]]

			<div class="inline-block divButAction"><a href="[view.urlcard]?id=[object.id]&action=delete&token=[view.token]" class="butActionDelete">[langs.transnoentities(Delete)]</a></div>
