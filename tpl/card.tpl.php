...
<div class="tabsAction">
	[onshow;block=begin;when [user.rights.massaction.write;noerr]=1]

		[onshow;block=begin;when [object.status]=[massaction.STATUS_DRAFT]]
		...
		[onshow;block=begin;when [object.status]=[massaction.STATUS_VALIDATED]]
		...
		<!-- '-+' est l'équivalent d'un signe '<' (TBS oblige) -->
		[onshow;block=begin;when [object.status]-+[massaction.STATUS_REFUSED]]
